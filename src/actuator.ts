...
import type { SenderMsg } from "./sendReceive.js";
...
export interface StateActuator<Model, Msg extends AnyMsg> {
  ...
  /**
   * An enhanced updater that allows for messages to be sent using a standard format.
   *
   */
  readonly sender: Updater<SenderMsg>;
